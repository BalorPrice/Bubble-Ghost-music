...
music.data0:	mdat "music/intro.raw"					; Compiledd to 0
music.data1:	mdat "music/main2.raw"					; 1554
music.data2:	mdat "music/end.raw"					; 15323

				ds 32
music.stack:	
			if defined (DEBUG)							; Simcoupe's monitor can't work out which label to use if I overload one address
				nop
			endif
...
music.play2:
	...
	@loop:
				...
				ld a,(music.speed)						; If speed is 2 then raise all octaves by one (Tetris 'panic' feature)
				cp 2
				ret nz
...
music.lengths:		dw 512 - 1							; lengths of non-looping songs, in frames
					dw 0, 0
...
music.medley.len: 	equ 10000							; Length to play a tune before moving to next one in a medley (Tetris feature)
...
music.int_mode:		db int_mode.attract					; (Tetris) int_mode.attract or int_mode.game.  Attract mode uses extra line interrupt for palette change
